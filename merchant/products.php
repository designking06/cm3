...
<div class="container text-center">
    <div id="addnew" class="w3-margin">
          <div class="row text-center">
                      <div class="col-sm-6">
            <a href="new.product.php?compID=<?php echo $_SESSION['compID'];?>"><h3 class="w3-btn w3-padding w3-text-blue">Add New Products</h3></a>
            </div>
              <div class="col-sm-6">
                  <a href="new.productline.php?compID=<?php echo $_SESSION['compID'];?>">
          ...
          $selectPL->execute([$_SESSION['compID']]);
          ...
          if($countPL>0){
            foreach($selectPL as $pL){
              ...
              $select->execute([$_SESSION['compID'],$pLID]);
