  ...
  <!-- Start Page Content -->
    ...
    <div id="choosePath" class="container w3-white w3-card w3-padding">
        ...
        <div class="row">
          ...
          <div class="col-sm-4 text-center"><a href="https://cagency.net/CM3/settings.php"><h3 class="w3-text-red">Settings</h3></a><p class="w3-small">Billing & Receiving Info</p></div>
    ...
    <!-- Start Task List Container -->
      <div id="tasks" class="container w3-white w3-card w3-padding"><hr>
              ...
              <div id="taskContainer" style="display:none;">
                ...
                <div id="viewDo" class="" style="padding:10 20 25 20;margin-bottom:20px;margin-top:20px;">
                    ...
                    <!-- this function is under inc/select.php -->
                      <?php if($_SESSION['permissions']['merchant']){selectTask($pdo,$_SESSION['compID']);}?>
                    <!-- End Task List -->
                </div>
